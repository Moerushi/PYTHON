...
# называется любая операция, у которой ровно два аргумента, как, например, у операции умножения.
...
def print_operation_table(operation, num_rows = 10, num_columns = 10):
  for j in range(1, num_columns + 1):
    for i in range(1, num_rows + 1):
      print('{:>3}'.format(operation(j,i)), end = " ")
    print()
   
# def print_operation_table(operation, num_rows = 6, num_columns = 6): # 2ой вариант
#   rowLines = [
#     [operation(i, j)
#     for j in range(1, num_columns + 1)] 
#     for i in range(1, num_rows + 1)
